...
if colorSpend == color_MASTER{
    draw_sprite_ext(sprDGoldGrad,floor(global.goldIndex)%4,salDX,salDY,salW*.5,salH*.5,0,c_white,1);
}else if colorSpend == color_PURE{
    draw_sprite_ext(sprDPureGrad,floor(global.goldIndex)%4,salDX,salDY,salW*.5,salH*.5,0,c_white,1);
